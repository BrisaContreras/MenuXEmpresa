...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('PRODUCTOS de Telmex'),
      ), //findeappbar
      body: Center(
...
class Contactos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Cliente Telemex'),
      ), //findeappbar
      body: Center(
        child: Text("Seccion Cliente"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/BrisaContreras/Mis_Imagenes/main/Diseno-sin-titulo-2.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
